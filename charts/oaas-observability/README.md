...
| https://open-telemetry.github.io/opentelemetry-helm-charts | opentelemetry-operator | 0.98.0 |
...
| prometheus.prometheusSpec.image.tag | string | `"v3.7.3"` |  |
...
| prometheus.prometheusSpec.version | string | `"v3.7.3"` |  |
