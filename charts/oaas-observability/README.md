...
| https://open-telemetry.github.io/opentelemetry-helm-charts | opentelemetry-operator | 0.97.1 |
...
| prometheus.prometheusSpec.image.tag | string | `"v3.7.1"` |  |
...
| prometheus.prometheusSpec.version | string | `"v3.7.1"` |  |
