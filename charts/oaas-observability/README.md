...
| https://open-telemetry.github.io/opentelemetry-helm-charts | opentelemetry-operator | 0.92.3 |
...
| prometheus.prometheusSpec.image.tag | string | `"v3.5.0"` |  |
...
| prometheus.prometheusSpec.version | string | `"v3.5.0"` |  |
