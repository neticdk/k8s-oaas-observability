...
![Version: 2.2.7](https://img.shields.io/badge/Version-2.2.7-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v3.7.2](https://img.shields.io/badge/AppVersion-v3.7.2-informational?style=flat-square)
...
| prometheusSpec.image | string | `"quay.io/prometheus/prometheus:v3.7.2"` |  |
...
| prometheusSpec.version | string | `"v3.7.2"` |  |
